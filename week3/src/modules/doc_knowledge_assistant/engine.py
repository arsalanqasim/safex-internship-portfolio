# Document Analysis & Knowledge-Base Assistant - Engine
# Developer: Ali Zaib (Group Member)
# For SafeX Solutions AI Agent Automation Proposal (Week 3)
#
# A Retrieval-Augmented Generation (RAG) pipeline that answers questions
# over a small set of company policy/FAQ documents:
#
...
# company standing in for Foodpanda per the assignment's substitution
# note — see README.md). All knowledge-base documents are original
# content written for this exercise, not sourced from any real company's
# actual policies, so there is no copyright/reproduction concern.
#
