...
Module: RAG-based Knowledge Assistant (`knowledge_assistant_airline`)
Member: Muhammad Faozan Mujtaba · SafeX Solutions Group 54
Date: 2026-08-24

| File | Purpose |
|---|---|
| `progress_report.md` | Week 4 progress report: assignment, delivery, results, blockers |
| `problems_encountered.md` | Problems found during the build, with causes and fixes |
| `daily_work_log.md` | Day-by-day log for the Week 4 window |
| `presentation_outline.md` | 10-slide deck outline plus the screenshot list |
...
See section 7 of `progress_report.md` for detail.
